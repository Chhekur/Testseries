		...
		<center>
			...
			<div id = "menu" style="text-align: left;">
				...
				<?php if ($_SESSION['usr_designation'] == 'admin'){?>
			  	...
			  	<?php }?>
			  	<div class = "tab">
					<label onclick = "window.location.href='/profile/referrals'" class = "menu-label" for="tab-four"><i class="material-icons" style="font-size: 13px;">account_box</i>&nbsp;&nbsp;Referrals</label>
				</div>
			  	<div class = "tab">
					<label onclick = "window.location.href='/profile/plans'" class = "menu-label" for="tab-four"><i class="material-icons" style="font-size: 13px;">monetization_on</i>&nbsp;&nbsp;Purchase</label>
				</div>
			     <div class="tab">
...
<ul id="slide-out" class="side-nav" style="background-color: #272c33;color:#d7d9e3;">
	...
	<center><div id = "left_sidebar"><br>
		<div style="border-bottom:1px solid #4e4e52; width: 80%;">
			...
			<h4><?php echo $_SESSION['usr_name'];?></h4>
			<!-- <h4><?php echo $_SESSION['validity'];?> days left</h4> --><br></div><br>
			<div id = "menu" style="text-align: left;">
				<div class = "tab">
					<center>
