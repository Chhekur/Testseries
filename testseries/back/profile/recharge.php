...
if($_POST['chek'] == 'get_payment_options'){
	...
	$response .= '<div class = "profile-box" style = "width:70%;"><h1 style = "text-align:left;">Other Payment Options</h1><br><div><div style = "float:left;"><img src = "" style = "display:inline-block;"><h1 style = "display:inline-block;">Credit Card / Debit Card / Net Banking</h1></div><form action = "/pay" method = "post"><input style = "display:none;" type = "text" name = "product_name" value = "'.$price.'_rs_recharge"><input style = "display:none;" type = "text" name = "product_price" value = "'.$price.'"><input style = "display:none;" type = "text" name = "name" value = "'.$_SESSION['usr_name'].'"><input style = "display:none;" type = "text" name = "phone" value = "'.$_SESSION['mobile'].'"><input style = "display:none;" type = "text" name = "email" value = "'.$_SESSION['usr_email'].'"><button class = "button is-warning" style = "height:20px;padding-top:0px;font-size:12px; float:right;">Pay</button></form></div><br></div>';
}
switch ($_POST['chek']) {
	case 'paytm':
		$option = '<div class = "profile-box" style = "width:70%;"><img src = "/../../assets/payment/paytm.jpg" style="width:300px;" /><br><h1>After payment fill this <a href = "https://goo.gl/forms/RvMIZzOpAZdBkirJ2">form</a></h1></div>';
		exit($option);
		break;
	case 'bhim':
		$option = '<div class = "profile-box" style = "width:70%;"><img src = "/../../assets/payment/bhim.jpg" style="width:300px;" /><br><h1>After payment fill this <a href = "https://goo.gl/forms/RvMIZzOpAZdBkirJ2">form</a></h1></div>';
		exit($option);
		break;
	case 'tej':
		$option = '<div class = "profile-box" style = "width:70%;"><h1>Open TEZ Apps</h1><h1>↓</h1><h1>Go to New Payment</h1><h1>↓</h1><h1>Enter Mobile No. : 9826440856</h1><h1>↓</h1><h1>Confirm Name - Dharam Prakash</h1><h1>↓</h1><h1>Pay Now</h1><br><h1>After payment fill this <a href = "https://goo.gl/forms/RvMIZzOpAZdBkirJ2">form</a></h1></div>';
		exit($option);
		break;
	case 'imps':
